...
public class ControllerLoggerAspectConfiguration {
    ...
    public class ControllerLoggerAspect {
        @Before("execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..controller..*(..))")
        ...
        @AfterThrowing(pointcut = "execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..controller..*(..))", throwing = "exception")
        ...
        @Around("execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..controller..*(..))")
