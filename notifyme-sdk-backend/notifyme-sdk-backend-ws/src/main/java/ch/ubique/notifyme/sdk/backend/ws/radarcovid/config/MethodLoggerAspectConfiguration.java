 ...
 */
package ch.ubique.notifyme.sdk.backend.ws.radarcovid.config;
...
public class MethodLoggerAspectConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger("ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable");

    @Aspect
    @Order(2)
    @Component
    public class MethodLoggerAspect {
        @Before("execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..business.impl..*(..))")
        ...
        @AfterThrowing(pointcut = "execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..business.impl..*(..))", throwing = "exception")
        ...
        @Around("execution(@ch.ubique.notifyme.sdk.backend.ws.radarcovid.annotation.Loggable * *..business.impl..*(..))")
