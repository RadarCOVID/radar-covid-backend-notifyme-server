...
public abstract class WSBaseConfig implements WebMvcConfigurer {
    ...
    public NotifyMeController notifyMeController(
            NotifyMeDataService notifyMeDataService) {
        return new NotifyMeController(
                notifyMeDataService, bucketSizeInMs, traceKeysCacheControlInMs);
    }
	...
	public static class DebugConfig {
		...
		@Bean
		public DebugController debugController(final NotifyMeDataService notifyMeDataService,
